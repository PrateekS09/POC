...
public class WsInBoundTest {
	...
	public void testWebServiceRequestAndResponse() {
		...
		Source payload = new StringSource(
				...
				"<testresponse xmlns=\"http://www.org.com/testwebservice\">testwsinbound</testresponse>");

		template.sendSourceAndReceiveToResult(WS_URI, payload, result);
		logger.info("RESULT: " + result.toString());
		assertThat(result.toString(), equalTo(
				"<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
				"<testresponse xmlns=\"http://www.org.com/testwebservice\">response:testwsinbound</testresponse>"));
	}
}
